...
CREATE TABLE Colaboradores (
 IdCodigoColaborador INTEGER UNIQUE NOT NULL,
...
CREATE TABLE Proyectos(
 ...
 PRIMARY KEY (IdProyecto,IdLineanegocioProyecto,IdDireccionProyecto,IdGerenteProyecto),
...
CREATE TABLE Proyectos_Colaboradores (
  ...
  CONSTRAINT Proyectos_Colaboradores_IdProyecto_fkey FOREIGN KEY (IdProyecto)
      REFERENCES Proyectos (IdProyecto) MATCH SIMPLE
